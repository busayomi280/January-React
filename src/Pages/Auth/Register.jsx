        ...
        <div className="flex h-[700px] w-full">
            ...
            <div className="w-full flex flex-col items-center justify-center">
                ...
                <form className="md:w-96 w-80 flex flex-col items-center justify-center">
                    <h2 className="text-4xl text-gray-300 font-medium">Register</h2>
                    <p className="text-sm text-gray-200/90 mt-3">Welcome! Please create an account to continue</p>
                    ...
                    <Link className="mt-8 w-full h-11 rounded-full text-white bg-indigo-500 hover:opacity-90 transition-opacity" to={"/auth/signin"}>
                    <button className='ml-50px' type="submit" >
                        Login
                    </button>
                    </Link>
                    <p className="text-gray-500/90 text-sm mt-4">Already have an account? <Link className="text-indigo-400 hover:underline" to={"/auth/signin"}>Sign in</Link></p>
                </form>
            </div>
        </div>
